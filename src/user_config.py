...
LLM_SETTINGS = {
    'analyze': {
        ...
        4. Your final answer must be a JSON in the format: {'recomendations': 'your recomendation in few words conected by _', 'analysis': 'your detailed analysis'}.
    ...
    'plan': {
        ...
        - You can add a "target" key only in the dimmer level.
